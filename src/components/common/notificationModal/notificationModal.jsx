...
const NotificationModal = ({ icon, id }) => {
      ...
      >
        ...
        <Fade in={open}>
          <div className={classes.paper}>
            {notificationText.length ? notificationText.data.map((elem) => <div key={elem.id}>{elem.agent.fio}</div>) : 'нет просмотров'}
          </div>
        </Fade>
      </Modal>
    </div>
